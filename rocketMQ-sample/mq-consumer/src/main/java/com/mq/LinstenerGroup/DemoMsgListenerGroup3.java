 ...
 */
//@Service
//@RocketMQMessageListener(consumerGroup = "${rocketmq.consumer.group3}", topic = "${rocketmq.consumer.topic}")
public class DemoMsgListenerGroup3 implements RocketMQListener<MessageExt> {
